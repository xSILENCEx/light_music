...
class PlayPageIndicator extends StatelessWidget {
  ...
  String _transform(int duration) {
    return DateTime.utc(0, 0, 0, 0, 0, 0, duration)
        .toString()
        .split(' ')[1]
        .split('.')[0];
  }
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        BlocBuilder<PlayBloc, PlayMag>(
          builder: (c, play) => Text(
            _transform(play.musicPlayer.data.duration),
            maxLines: 1,
        ...
        ///进度时间
        BlocBuilder<IndicatorBloc, IndicatorMag>(builder: (c, ind) {
          return Text(
...
class _JustIndicatorState extends State<JustIndicator> {
  ...
  Future<void> _seekTo(int s) async =>
      await BlocProvider.of<PlayBloc>(context).seekTo(s);
      ...
      builder: (c, ind) {
        ...
        return SleekCircularSlider(
          ...
          appearance: CircularSliderAppearance(
            ...
            size: widget.centerSize + Lp.w(100),
