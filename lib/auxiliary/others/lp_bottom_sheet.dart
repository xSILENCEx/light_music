...
const double _minFlingVelocity = 1;
const double _closeProgressThreshold = 0.0;
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  // @override
  // Animation<double> get animation => lpAnimation;

  // @override
  // Animation<double> get secondaryAnimation => lpSecondaryAnimation;
